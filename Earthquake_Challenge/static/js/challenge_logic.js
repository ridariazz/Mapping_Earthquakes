...
// 1. Add a 2nd  and 3rd layer group for the tectonic plate data as well as the major eq data.
let allEarthquakes = new L.LayerGroup();
let tectonicPlates = new L.LayerGroup();
let majorEQ = new L.LayerGroup();

// 2. Add a reference to the tectonic plates and major eq group to the overlays object.
let overlays = {
